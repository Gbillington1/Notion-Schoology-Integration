class Event {
     ...
     * @param {string} projectPageID - The ID of the project page in the Projects DB. Used to link page to row in master
     * @param {string} status - The status of the event as shown in Notion
     */
    constructor(eventID, title, database, date, priority = "Medium", projectPageID = null, status = "To Do") {
